(function () {
    ...
    var wangjiaoEffect = {
        ...
        Bounce: {
            easeIn: function (t, b, c, d) {
                return c - wangjiaoEffect.Bounce.easeOut(d - t, 0, c, d) + b;
            },
            ...
            easeInOut: function (t, b, c, d) {
                if (t < d / 2) {
                    return wangjiaoEffect.Bounce.easeIn(t * 2, 0, c, d) * .5 + b;
                }
                return wangjiaoEffect.Bounce.easeOut(t * 2 - d, 0, c, d) * .5 + c * .5 + b;
            }
        },
        //二次方的缓动
        Quad: {
    ...
    function animate(curEle, tarObj, duration, effect) {
        ...
        wangjiaoEvent.fire.call(curEle, "wangjiaoAnimateStart");
        ...
        curEle.timer = window.setInterval(function () {
            ...
            if (times >= duration) {
                ...
                wangjiaoEvent.fire.call(curEle, "wangjiaoAnimateEnd");
                return;
            }
    ...
    window.wangjiaoAnimate = animate;
})();